...
<script type="text/javascript">
    $(function() {
        $('#mailtempEditForm').form({
            url : '${path}/mailtemp/edit',
            onSubmit : function() {
                progressLoad();
        ...
        $("#editStatus").val('${mailtemp.status}'); 
        
    });
</script>
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="mailtempEditForm" method="post">
            <table class="grid">
              		         <tr>
                    <td>id</td>
                    ...
                    <td><input name="deleteflag" type="text" class="easyui-textbox"  data-options="required:true" value=""></td>
		                    ...
		                    <tr>
                    <td>商家名称</td>
                    <td><input name="id" type="hidden"  value="${mailtemp.id}">
                    <input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox" data-options="required:true" value="${mailtemp.name}"></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
